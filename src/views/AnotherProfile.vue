...
const authorBucket = computed(() =>
  authorId.value ? recipesStore.authors[authorId.value] : undefined
);
    ...
    >
      ...
      <div v-else-if="profile">
        <div class="relative mb-5 flex justify-center">
          <ProfilePicForm :src="profile.profilePic || null" />
        </div>
