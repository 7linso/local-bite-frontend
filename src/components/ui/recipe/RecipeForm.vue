...
<template>
  <section class="flex items-center justify-center my-10">
    <div
      class="w-[90%] sm:w-[400px] md:w-[500px] lg:w-[600px] bg-white rounded-2xl shadow-sm overflow-hidden border border-gray-100"
    >
      <!-- recipe pic -->
      ...
      <form @submit.prevent="emit('submit')" class="p-5 text-sm">
        <p v-if="errors.form" class="text-xs text-red-600 mb-2">
          {{ errors.form }}
        </p>
        ...
        >
          ...
          <div>
            ...
            >
              <div
                class="grid items-center gap-2 grid-cols-[11fr_4fr_4fr_1fr] md:grid-cols-[13fr_3fr_3fr_1fr]"
              >
                <div class="min-w-0">
                  <input
              ...
              <template #item="{ element, index }">
                <div class="flex flex-row items-center gap-2">
                  ...
                  <div class="flex flex-row items-center gap-2">
                    ...
                    <button
                      type="button"
                      class="drag-handle cursor-move text-gray-400 text-sm"
                      title="Reorder"
                    >
                      <ArrowDownUp :size="14"/>
                    </button>
          ...
          <label for="locality" class="md:text-right md:self-start md:pt-1">
            locality
          </label>
          <div>
          ...
          <label for="area" class="md:text-right md:self-start md:pt-1">
            area
          </label>
          <input
          ...
          <label for="country" class="md:text-right md:self-start md:pt-1">
            country
          </label>
          <input
...
:deep(.multiselect__option--selected.multiselect__option--highlight) {
  @apply bg-blue-100 text-amber-700;
}
...
:deep(.multiselect__tag) {
  @apply bg-white text-amber-700 border border-gray-300;
}
