...
<template>
  <Transition name="overlay-fade">
    ...
    >
      ...
      >
        <aside
          class="fixed bottom-0 left-0 right-0 z-40 h-1/2 bg-white border border-amber-900 rounded-t-4xl shadow-2xl flex flex-col overflow-hidden"
          @click.stop
        >
          <div
            class="min-h-0 grow overflow-y-auto overscroll-contain p-4 [--webkit-overflow-scrolling:touch]"
          >
            <RecipesList
